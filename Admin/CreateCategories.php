                                ...
                                class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $Rows['cat_desc']; ?></td>
                                            <td><?php echo $Rows['stat']; ?></td>
                                            <td>
                                            <?php 
                                            
                                            echo "
                                            <img class='imgview' src='../uploadimages/{$Rows['cat_image']}'>";

                                            ?></td>
                                            <?="
                                            <td>
                                            <a href='deleteCategories.php?id={$Rows['cat_id']}' 
                                            ...
                                            <?="
                                            <td>
                                            <a href='UpdateCategories.php?id={$Rows['cat_id']}' 
