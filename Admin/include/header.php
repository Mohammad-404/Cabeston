...
<!--                         <ul class="sub-menu children dropdown-menu">
                    ...
                    <li class="menu-title">Admin Manegar</li><!-- /.menu-title -->
                    <li class="menu-item-has-children">
                        <a href="AddAdmin.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>CreateAdmin</a>
                    </li>

                    <li class="menu-title">Contact US</li><!-- /.menu-title -->
                    <li class="menu-item-has-children">
                        <a href="contact.php" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Info Contact</a>
                    </li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <!------------------LOGO------------------------->
                    <a class="navbar-brand" href="./"><img src="images/admins.jpg" class="logoadmins" alt="Logo"></a>
                    <a class="navbar-brand hidden" href="./"><img class="logoadmins" src="images/admins.jpg" alt="Logo"></a>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                           <img class="user-avatar rounded-circle" src="images/admins.jpg" alt="User Avatar">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="profileVendor.php"><i class="fa fa- user"></i>Profiles Vendor</a>
