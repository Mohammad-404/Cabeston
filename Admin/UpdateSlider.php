<?php
    ...
    if (isset($_POST['sub'])) {
        ...
        if ($_FILES['image_slider']['name'] != "") {
            ...
            $Vendors->image1 = $DateValue['image'];
        }
        move_uploaded_file($tmp_image,$path.$Vendors->image1);
        
        $Vendors->UpdateSlider($id);
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        name="text2_slider"
                                        value="<?=$DateValue['texttow']?>">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <?=
                                        "<img class='imagesss' src='../uploadimages/{$DateValue['image']}'>";
                                    ?>
                                    <br>
